...
However, if we compare the estimates with the DiD estimates in Section~\ref{sec:twfe}, it would be reasonable to infer that the OLS, PSM, and IPW esimaters are all still inflated because of the unobserved coundefenders like Team Skill.
