...
We illustrate their use through a running example: \emph{estimating the impact of AI coding assistant adoption on development productivity}.
...
We then show how plausible violations of those assumptions (for example, AI-adopting projects differ in ways that affect productivity) motivate progressively stronger designs: multivariate regressions, longitudinal comparisons, and staggered difference-in-differences that builds a natural experiment setting from variations in adoption timing. 
...
Each design involves a different constellation of assumptions and trade-offs, and reasoning about these explicitly is more productive than retreating to the blanket disclaimer that correlation does not imply causation.

Importantly, the credibility of a causal argument rests on more than the appropriate application of a statistical method. 
For DAG-based causal inference, a researcher would need deep SE domain knowledge and data analysis expertise to argue that all the 

For design-based identification, 

A researcher with deep domain knowledge about the mechanisms through which AI tools might affect productivity, about the organizational factors that drive adoption decisions, can construct a more compelling argument from observational data than one who applies a sophisticated estimator without such understanding. DAGs provide a way to encode and communicate this domain knowledge, making it available for scrutiny and debate, though they are a tool for transparency, not a substitute for expertise.
