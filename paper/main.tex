...
Psychology's replication crisis led to sweeping methodological reforms---pre-registration, registered reports, estimand-first workflows---that would have seemed unnecessary five years before they became mandatory~\cite{grosz2020taboo}.
SE is earlier on this trajectory, but the trajectory is clear.
...
Recent editorial guidance in adjacent fields has begun requiring authors to specify causal questions and justify covariate selection~\cite{lederer2019control}; similar expectations will likely emerge in SE venues.
