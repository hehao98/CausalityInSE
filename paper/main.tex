...
% TODO: Quantitative citation analysis of Ray et al. and media/practitioner examples.
% See plans/20260327 - PL Code Quality Literature Synthesis.md for detailed plan.
% Stream 1: Quantitative citation analysis using scripts/fetch_ray_citations.py
%           and scripts/classify_ray_citations.py -> data/ray_citations.csv
