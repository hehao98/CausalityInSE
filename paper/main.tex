...
In this graph, we consider the number of stars received as a \emph{collider} (AI Tool Adoption $\to$ Stars $\leftarrow$ Dev.\ Velocity): Conditioning on it opens a spurious path and must be avoided.}
\label{fig:ai-dag}
\end{figure}
