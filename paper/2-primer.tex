...
Before analyzing data, articulate the \emph{target trial}~\cite{hernan2020causal}: Every causal question implicitly describes a hypothetical randomized experiment, and naming that trial concretely is the most effective way to expose what an observational study is actually trying to estimate.
